export default {
  ...
  apply: {
    heading: 'Apply',
    prerequisites: 'To apply a listing to the Registry, you must first approve the Registry smart contract to transfer your tokens. Enter the amount of tokens you would like to approve and enable for registry transactions.',
  },
  challenge: {
    heading: 'Challenge',
