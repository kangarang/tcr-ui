...
// Contracts-general
export const TX_CHECK_TEST = 'TX_CHECK_TEST--|--Contract'
export const EXECUTE_METHOD_REQUEST = 'EXECUTE_METHOD_REQUEST--|--Contract'
export const SET_ABI = 'SET_ABI--|--Contract'
export const SET_METHOD_ARGS = 'SET_METHOD_ARGS--|--Contract'
export const EXECUTE_METH = 'EXECUTE_METH--|--Contract'
export const SET_LOGS = 'SET_LOGS--|--Contract'
export const POLL_LOGS_REQUEST = 'POLL_LOGS_REQUEST--|--Contract'
export const SET_DECODED_LOGS = 'SET_DECODED_LOGS--|--Contract'

// Token
export const SET_TOKENS_ALLOWED = 'SET_TOKENS_ALLOWED--|--Token'
export const EV_TRANSFER = 'EV_TRANSFER--|--Token'
...
export const NEW_ITEM = 'NEW_ITEM--|--Reducer'
export const CHANGE_ITEM = 'CHANGE_ITEM--|--Reducer'
