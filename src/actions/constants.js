...
export const IPFS_ADD_REQUEST = 'IPFS_ADD_REQUEST--|--IPFS'
export const IPFS_ABI_RETRIEVED = 'IPFS_ABI_RETRIEVED--|--IPFS'
...
export const UPDATE_LISTING = 'UPDATE_LISTING--|--Home'
