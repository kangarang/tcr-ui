...
export const SET_METHOD_ARGS = 'SET_METHOD_ARGS--|--UDapp'
export const CHANGE_SLIDER_VALUE = 'CHANGE_SLIDER_VALUE--|--UDapp'

export const SET_ETHEREUM_PROVIDER = 'SET_ETHEREUM_PROVIDER--|--Home'
export const SELECT_CUSTOM_METHODS = 'SELECT_CUSTOM_METHODS--|--Home'
export const SEND_TRANSACTION_REQUESTED = 'SEND_TRANSACTION_REQUESTED--|--Home'
...
export const GET_ETH_PROVIDER = 'GET_ETH_PROVIDER--|--Home'
