...
var Countdown = function (_React$Component) {
  ...
  function Countdown() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Countdown.__proto__ || Object.getPrototypeOf(Countdown)).call.apply(_ref, [this].concat(args))), _this), _this.draw = function () {
      ...
      if (delta > FRAME_EVERY) {
        _this.forceUpdate();
        _this.lastDraw = now - delta % FRAME_EVERY;
      }
    }, _temp), possibleConstructorReturn(_this, _ret);
  }
...
})(['padding-left:', ';padding-right:', ';font-weight:normal;text-align:', ';white-space:nowrap;'], function (_ref) {
  var align = _ref.align;
